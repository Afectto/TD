...
public class PirceDamageWeaponBuff: MonoBehaviour, IBuff
{
    ...
    {
        PierceWeaponStatsMultiplayer.Instance.IncreasedMultiplayer(MultiplayerType.Damage, value/100);
        return baseStats;
    }

    public string getSkin()
    {
        string nameSkin = "Inventory/BaseBuff/PierceAttackDamage_";
        switch (value)
        {
            case 5: nameSkin += "1";
                break;
